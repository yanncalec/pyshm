...
def main():
    ...
    parser.add_argument('outdir', nargs='?', type=str, default=None, help='directory where figures are saved (default: in the same folder as input_data_file).')

    parser = argparse.ArgumentParser(usage=usage_msg+'\n'+parm_msg)

    parser.add_argument('--vthresh', dest='vthresh', type=float, default=4., help='Threshold value for event detection (default=4).')
    parser.add_argument('--mwsize0', dest='mwsize0', type=int, default=6, help='Size of the moving window for local statistics (default=6).')
    parser.add_argument('--mwsize1', dest='mwsize1', type=int, default=24*10, help='Size of the moving window for global statistics (default=24*10).')
