# Spectral Projected Gradient method for constrainted convex optimization
...
default_options.maxIter = 1000 # default 500
...
def SPG(funObj0, funProj, x, options=default_options):
    ...
    f, g = funObj(x) # function value and gradient
    projects = 1
    funEvals = 1
