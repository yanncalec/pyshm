...
class shfinvsp:
    ...
    def synthesis(self, X, axis=-1):
        """Synthesis or the backward operator.
        """
    ...
    def pinv_synthesis(self, X, axis=-1):
        """Pseudo-inverse of the backward operator.
        """
...
class MxDeconv:
    ...
    @staticmethod
    def _fit(Yvar, Xvars, lags, constflag, tidx0, tidx1, Ntrn, method):
    ...
    def fit(self, constflag=False, tidx0=None, Ntrn=None, method='ls'):
        ...
        self._fit_result = MxDeconv._fit(self.Yvar, self.Xvar, self.lag, constflag, tidx0, tidx1, Ntrn, method)
...
class OmxDeconv(MxDeconv):
    ...
    def fit(self, constflag=False, tidx0=None, Ntrn=None, method='ls'):
        ...
        for X, lag in zip(self.Xvar, self.lag):
            res = MxDeconv._fit(Err, [X], [lag], constflag, tidx0, tidx1, Ntrn, method)
            L, Cvec, Err, Sig2 = res
